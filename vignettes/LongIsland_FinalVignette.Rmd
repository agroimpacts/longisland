...
geom_point(shape= 21, fill= "#33CCCC", colour= "black", size=2) + xlab("Date") + ylab("Dissolved Oxygen") + ggtitle( "Dissolved Oxygen at bC1") + theme_light() +labs(subtitle = "Oxygen in mg/L", caption = "Enough dissolved oxygen content is an important indicator of good water quality") + theme(plot.title=element_text(face="bold", size=14))
bC1_oxygen

bC1_temp <- ggplot(bC1, aes(newdate, temp, fill = group)) +
geom_point(shape= 21, fill= "#33CCCC", colour= "black", size=2) + xlab("Date") + ylab("Temperature") + ggtitle("Temperaute at bC1") + theme_light() +labs(subtitle = "Temperature in C", caption = "Drastic temperautre change is an important indicator of water quality change") + theme(plot.title=element_text(face="bold", size=14))
bC1_temp

bC1_sal <- ggplot(bC1, aes(newdate, sal, fill = group)) +
geom_point(shape= 21, fill= "#33CCCC", colour= "black", size=2) + xlab("Date") + ylab("Salinity") + ggtitle("Water Salinity at bC1") + theme_light() +labs(subtitle = "Oxygen in mg/L", caption = "Drastic salinity change is an important indicator of water quality change") + theme(plot.title=element_text(face="bold", size=14))
bC1_sal
```
...
```{r}
b16 <- readr::read_csv(
  system.file("extdata/16.csv", package = "longisland")) 
b16
...
shellny_oy_p <- ggplot(shellny_oy, aes(year, oysters)) + 
geom_line(shape= 21, lwd = 1, colour= "#33CCCC", size=2) +
xlab("Year") + ylab("Oysters Bushels") + 
ggtitle( "Oysters Bushels at NY") + theme_light()
shellny_oy_p

shellny_clams_p <- ggplot(shellny_clams, aes(year, clams)) + 
geom_line(shape= 21, lwd = 1, colour= "black", size=2) +
xlab("Year") + ylab("Clam Bags") + 
ggtitle( "Clam Bags at NY") + theme_light()
shellny_clams_p
```
...
warmcoldspring<- readr::read_csv(system.file("extdata/warmcoldspring.csv", package = "longisland"))
wcfall <- warmcoldfall
